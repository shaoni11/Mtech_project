...
from multimodal_datapipeline.utils.paths import project_root
...
from data.sources.chembl import chembl_fetch_activities, chembl_fetch_targets_for_uniprot
from data.sources.scrape import scrape_html_table
...
def requests_session():
    try:
        ...
        raise ImportError(
            "requests is required for data acquisition. Install project dependencies with: "

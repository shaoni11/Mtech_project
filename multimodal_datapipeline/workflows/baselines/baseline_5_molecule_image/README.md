...
python workflows/baselines/baseline_5_molecule_image/curate_data.py
python workflows/baselines/baseline_5_molecule_image/validate_inputs.py
python workflows/baselines/baseline_5_molecule_image/train.py
```
